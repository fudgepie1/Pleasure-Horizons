...
public class GirlRegistry {
    ...
    public static final EntityType<CoppieEntity> COPPIE = PleasureCraftEntities.registerGirl("coppie", CoppieEntity::new, 0.5f, 1.35f, CoppieEntity::createAttributes);
