package com.sandymandy.pleasurecraft.client.rendering.layers;
...
public class BoneOverrideRenderLayer<T extends GeoAnimatable, O, R extends GeoRenderState>
    ...
    public void render(R state,
        ...
        // Maps
        Map<String, Identifier> layer1 = state.getGeckolibData(PleasureCraftDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES);
        Map<String, Identifier> layer2 = state.getGeckolibData(PleasureCraftDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES_LAYER_TWO);
        Map<String, Identifier> layer3 = state.getGeckolibData(PleasureCraftDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES_LAYER_THREE);
