...
public record RegisterCustomGirlRandomSoundC2SPacket(String girlID, String key, List<SoundEvent> sounds) implements CustomPayload {
    public static final CustomPayload.Id<RegisterCustomGirlRandomSoundC2SPacket> ID = new Id<>(Identifier.of(PleasureCraft.MOD_ID, "register_custom_girl_random_sounds"));
