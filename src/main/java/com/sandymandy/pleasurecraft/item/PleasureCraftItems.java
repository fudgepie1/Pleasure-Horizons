...
import com.sandymandy.pleasurecraft.item.items.SettlementRecruitContract;
...
public class PleasureCraftItems {
    ...
    public static Item MILK_JUG_HALF = registerItem("milk_jug_half", settings -> new Item(applyMilkJugComponents(settings).useRemainder(PleasureCraftItems.MILK_JUG_EMPTY)));

    public static Item MILK_JUG_FULL = registerItem("milk_jug_full", settings -> new Item(applyMilkJugComponents(settings).useRemainder(PleasureCraftItems.MILK_JUG_HALF)));
