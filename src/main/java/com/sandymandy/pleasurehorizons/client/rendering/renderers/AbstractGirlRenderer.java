...
import com.sandymandy.pleasurehorizons.networking.C2S.BonePosSyncC2SPacket;
...
import com.sandymandy.pleasurehorizons.util.rendering.UnlitNormalVertexConsumer;
...
public abstract class AbstractGirlRenderer<T extends GirlSceneEntity, R extends LivingEntityRenderState & GeoRenderState> extends GeoEntityRenderer<T, R> {
    ...
    public AbstractGirlRenderer(EntityRendererFactory.Context renderManager, GeoModel<T> model) {
        ...
        this.addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            ...
            public void addRenderData(T animatable, Void relatedObject, R renderState) {
                renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_MAIN_HAND_STACK, animatable.getMainHandStack());
                renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_WEAPON_BONE_ROTATION_X, animatable.getWeaponBoneXRotation());
            }
            ...
            protected void renderStackForBone(
                ...
                float boneRotX = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_WEAPON_BONE_ROTATION_X);
                ...
                boolean isNotInScene = !renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.IS_IN_SCENE);
    ...
    @Override
    public void addRenderData(T animatable, Void relatedObject, R renderState) {
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.IS_STRIPPED, animatable.isStripped());
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.IS_IN_SCENE, animatable.isSceneActive());
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.HAS_VEHICLE, animatable.hasVehicle());
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.IS_SPRINTING, animatable.isSprinting());
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_ID, animatable.getGirlID());
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.ENTITY_ID, animatable.getId());
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_FIRST_PASSENGER, animatable.getFirstPassenger());
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_VISIBILITY, animatable.boneVisibility);
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_UV_OFFSETS, animatable.boneUVOffsets);
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES, animatable.boneTextureOverrides);
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES_LAYER_TWO, new HashMap<>(animatable.boneTextureOverridesLayer2));
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES_LAYER_THREE, new HashMap<>(animatable.boneTextureOverridesLayer3));
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_COLOR_OVERRIDES, new HashMap<>(animatable.boneColorOverrides));
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_SIZE_OVERRIDES, new HashMap<>(animatable.boneSizeOverrides));
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_POSITION_OFFSET, new HashMap<>(animatable.bonePositionOffset));
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.PASSENGER_BONE_NAME, animatable.passengerBoneName);
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.YAW, animatable.getYaw());
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.PREVIOUS_YAW, animatable.previousYaw);
        renderState.addGeckolibData(PleasureHorizonsDataTicketRegistry.PREVIOUS_VELOCITY, animatable.previousVelocity);
    }
    ...
    public void preRender(R renderState, MatrixStack poseStack, BakedGeoModel model, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, int packedLight, int packedOverlay, int renderColor) {
        this.mainHandItem = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_MAIN_HAND_STACK);

        super.preRender(renderState, poseStack, model, bufferSource, buffer, isReRender, packedLight, packedOverlay, renderColor);

        Map<String, Boolean> boneVisibility = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_VISIBILITY);
        Map<String, Vec3d> boneSize = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_SIZE_OVERRIDES);
        Map<String, Vec3d> bonePos = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_POSITION_OFFSET);
    ...
    public void renderFinal(R renderState, MatrixStack poseStack, BakedGeoModel model, VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, int renderColor) {
        String passengerBoneName = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.PASSENGER_BONE_NAME);
        ...
        if(getGeoModel().getBone(passengerBoneName).isPresent()){
            ...
            ClientPlayNetworking.send(new BonePosSyncC2SPacket(renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.ENTITY_ID), new Vec3d(bonePos.x, bonePos.y, bonePos.z)));
        }
    ...
    public void applyRenderLayers(R renderState,
        ...
        Map<String, Identifier> boneTexOverrides = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES);
        Map<String, Identifier> boneTexOverridesLayer2 = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES_LAYER_TWO);
        Map<String, Identifier> boneTexOverridesLayer3 = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES_LAYER_THREE);
    ...
    public static boolean ARE_SHADERS_DISABLED = PleasureHorizonsClient.areIrisShadersDisabled();

    public static void updateShadingState() {
        IS_SHADING_DISABLED = ModConfig.INSTANCE.girls.disableShading;
        ARE_SHADERS_DISABLED = PleasureHorizonsClient.areIrisShadersDisabled();
    }
    ...
    public void renderRecursively(R renderState,
        ...
        Map<String, Identifier> boneTexOverrides = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_TEXTURE_OVERRIDES);
        Map<String, Vec2f> boneUVOffsets = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_UV_OFFSETS);
        Map<String, Integer> boneColorOverrides = renderState.getGeckolibData(PleasureHorizonsDataTicketRegistry.GIRL_BONE_COLOR_OVERRIDES);
