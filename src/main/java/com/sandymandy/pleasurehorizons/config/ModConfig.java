...
import com.sandymandy.pleasurehorizons.config.gui.AutoConfigExtensions;
import com.sandymandy.pleasurehorizons.config.gui.BoundedContinuous;
import com.sandymandy.pleasurehorizons.config.gui.ModBindingsConfig;
import org.jetbrains.annotations.NotNull;

@Config(name = PleasureHorizons.MOD_ID)
public class ModConfig implements ConfigData {
    ...
    public enum FlightMode implements SelectionListEntry.Translatable {
        ...
        FlightMode(String name) {
            this.key = "text.autoconfig.pleasurehorizons.option.movement.flightMode." + name;
        }
    ...
    public enum InteractionMode implements SelectionListEntry.Translatable {
        ...
        InteractionMode(String name) {
            this.key = "text.autoconfig.pleasurehorizons.option.utility.interactionMode." + name;
        }
