...
import com.sandymandy.pleasurehorizons.client.rendering.renderers.*;
...
import com.sandymandy.pleasurehorizons.networking.PleasureHorizonsClientPackets;
import com.sandymandy.pleasurehorizons.registries.GirlRegistry;
import com.sandymandy.pleasurehorizons.registries.PleasureHorizonsHudRegistry;
import com.sandymandy.pleasurehorizons.util.SceneKeyframeEventReloader;
...
public class PleasureHorizonsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        PleasureHorizonsKeybinds.register();
        PleasureHorizonsClientPackets.registerS2CPackets();
        PleasureHorizonsHudRegistry.register();
        handleKeybinds();
    ...
    private static void handleKeybinds() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (holdMode) {
                newThrustState = PleasureHorizonsKeybinds.thrustKey.isPressed();
            }
            else {
                if (PleasureHorizonsKeybinds.thrustKey.wasPressed()) {
            ...
            if (PleasureHorizonsKeybinds.cumKey.wasPressed()) {
